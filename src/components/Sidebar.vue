  ...
  <v-navigation-drawer permanent class="py-6" width="300" color="#2B343F">
    ...
    <v-list>
      ...
      <v-list-group value="Reports">
        ...
        <v-list-item title="Job Reports" prepend-icon="mdi-file-document-outline" link
          to="/admin/reports/jobs"></v-list-item>
        <v-list-item title="Member Reports" prepend-icon="mdi-file-table-outline" link
          to="/admin/reports/members"></v-list-item>
        <v-list-item title="Payroll Reports" prepend-icon="mdi-file-send-outline" link
          to="/admin/reports/payrolls"></v-list-item>
      </v-list-group>
